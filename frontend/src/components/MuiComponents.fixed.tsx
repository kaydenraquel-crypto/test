// Enhanced MUI Components for NovaSignal App - Fixed Version
...
// Market status indicator - Fixed version
...
// Symbol input with validation - Fixed version
...
// Price change chip - Fixed version  
...
export const PriceChangeChip: React.FC<PriceChangeChipProps> = ({
  ...
  return (
    <Chip
      ...
      sx={{
        fontWeight: 600,
        backgroundColor: isPositive ? designTokens.colors.trading.buy : designTokens.colors.trading.sell,
        color: 'white',
      }}
    />
  )
...
// Stats display component - Fixed version
...
export const ChartSkeleton: React.FC<{ height?: number }> = ({ height = 400 }) => (
  <Box data-testid="chart-skeleton">
    <Skeleton variant="rectangular" height={height} sx={{ borderRadius: 2, mb: 1 }} data-testid="skeleton-chart" />
    <Stack direction="row" spacing={1}>
      <Skeleton variant="rectangular" width={80} height={24} sx={{ borderRadius: 1 }} data-testid="skeleton-control" />
      <Skeleton variant="rectangular" width={60} height={24} sx={{ borderRadius: 1 }} data-testid="skeleton-control" />
      <Skeleton variant="rectangular" width={100} height={24} sx={{ borderRadius: 1 }} data-testid="skeleton-control" />
    </Stack>
  </Box>
)
...
export const DataPanelSkeleton: React.FC<{ rows?: number }> = ({ rows = 5 }) => (
  <Stack spacing={1} data-testid="data-panel-skeleton">
    {Array.from({ length: rows }).map((_, i) => (
      <Box key={i} display="flex" alignItems="center" spacing={2}>
        <Skeleton variant="circular" width={24} height={24} data-testid="skeleton-icon" />
        <Box flex={1}>
          <Skeleton variant="text" width="60%" height={20} data-testid="skeleton-text" />
          <Skeleton variant="text" width="40%" height={16} data-testid="skeleton-text" />
        </Box>
        <Skeleton variant="text" width={80} height={20} data-testid="skeleton-value" />
      </Box>
    ))}
  </Stack>
)

// Signals list component - Fixed version
